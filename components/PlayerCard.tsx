...
import { ChevronDown, ChevronUp, Plus, Image as ImageIcon, Shield, ImagePlus, Camera, X, Maximize2, Trash2, Tag } from 'lucide-react';
import { PlayerConfig, ROLE_DATA, CONFIG_CATEGORIES, PLAYER_POSITIONS } from '../types';
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-1">
            ...
            <div className="flex gap-2 items-end overflow-hidden">
              ...
              <div className="shrink-0 w-20 flex items-center border-b border-slate-700 bg-slate-800/20 px-1.5 rounded-t-sm transition-all">
                <span className="shrink-0 text-[9px] font-black text-yellow-600/60 mr-1.5">Lv.</span>
                <input
                  type="text"
                  placeholder=""
                  value={player.level}
